...
struct BridgeStress(u64);

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct LoadFactor(u64);
...
impl JungleOperator {
    ...
    fn apply(&self, left_load: u64, right_load: u64) -> Option<u64> {
        match self {
...
struct BridgeEquation {
    target_stress: BridgeStress,
    load_factors: Vec<LoadFactor>,
}
...
impl BridgeEquation {
    ...
    fn is_calibratable(&self, allow_string_join: bool) -> bool {
...
impl BridgeCalibrator {
    ...
    fn calculate_basic_stress(&self) -> u64 {
        self.equations
            .iter()
    ...
    fn calculate_advanced_stress(&self) -> u64 {
        self.equations
            .iter()
